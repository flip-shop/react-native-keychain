 ...
 * */
public class CipherStorageBlockStoreApiLegacy implements CipherStorage {

  private static final String TAG = CipherStorageBlockStoreApiLegacy.class.getSimpleName();
  ...
  public CipherStorageBlockStoreApiLegacy(Context context) {
